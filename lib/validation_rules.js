...
exports.validationRules = [
  ...
  [
    ...
    body("pass")
      ...
      .withMessage(
        "Password lenght must be minimum 5 & maximum 20 character length"
      )
      .isStrongPassword({
        minLength: 5,
        minLowercase: 1,
    ...
    body("comfirm-password").custom((value, { req }) => {
  ...
  [
    ...
    body("course_code")
      ...
      .isLength({ min: 4 })
      .withMessage("Course code must be a minimum of 4 alphnumeric length")
      .matches(/^[a-zA-Z0-9]*$/)
